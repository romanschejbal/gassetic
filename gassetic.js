...
(function() {
  var Gassetic, clean, frep, fs, gulp, gutil, jsYaml, livereload, path, q, tap;
  ...
  module.exports = Gassetic = (function() {
    ...
    Gassetic.prototype.loadConfig = function() {
      return this.config = jsYaml.safeLoad(fs.readFileSync('gassetic.yml', 'utf8'));
    };
    ...
    Gassetic.prototype.includeModules = function() {
      var key, value, _ref, _results;
      this.modules = {};
      _ref = this.config.requires;
      _results = [];
      for (key in _ref) {
        value = _ref[key];
        _results.push(this.modules[key] = require(path.join(this.cwd(), value)));
      }
      return _results;
    };
